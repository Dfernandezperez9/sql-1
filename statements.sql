...
-- SELECT *, COUNT(lenguaje) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY id_usuario;
...
-- SELECT * FROM usuarios_lenguajes WHERE edad < 30 AND LENGTH(lenguaje) = (SELECT MAX(LENGTH(lenguaje)) FROM usuarios_lenguajes);
...
-- SELECT * FROM usuarios_lenguajes WHERE edad > 30 AND LENGTH(lenguaje) = (SELECT MIN(LENGTH(lenguaje)) FROM usuarios_lenguajes);
...
-- SELECT *, edad - (SELECT AVG(edad) FROM usuarios_lenguajes) FROM usuarios_lenguajes;
